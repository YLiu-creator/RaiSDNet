...
class Fmeasure_and_FNR(object):
    ...
    def get_results(self) -> dict:
        ...
        self.adaptive_fms.clear(),self.changeable_fms.clear(),self.fnrs.clear(),self.precisions.clear(),self.recalls.clear()
...
class Emeasure(object):
    ...
    def get_results(self) -> dict:
        ...
        self.adaptive_ems.clear(),self.changeable_ems.clear()
